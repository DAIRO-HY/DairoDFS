...
func startWebServer(port int) {
	...
	http.HandleFunc("/app/files.html", func(writer http.ResponseWriter, request *http.Request) {
			...
			defer func() {
				...
				body = inerceptor.RemoveGoroutineLocal(writer, request, body)
				writeToTemplate(writer, body, "resources/templates/app/files.html", "resources/templates/app/include/files/files_toolbar.html", "resources/templates/app/include/files/files_right_option.html", "resources/templates/app/include/share_detail_dialog.html", "resources/templates/app/include/file_property_dialog.html", "resources/templates/app/include/head.html", "resources/templates/app/include/top-bar.html", "resources/templates/app/include/files/files_upload.html", "resources/templates/app/include/files_list.html", "resources/templates/app/include/files/files_share.html")
			}()
			if !inerceptor.StartTransaction(writer, request) {
				return
			}
	...
	http.HandleFunc("/share/", func(writer http.ResponseWriter, request *http.Request) {
		...
		if isPathVariable(varPath, pathVariableSplitArr){// 判断是否满足定义的路由参数规则
			...
			defer func() {
				...
				body = inerceptor.Commit(writer, request, body)
				body = inerceptor.RemoveGoroutineLocal(writer, request, body)
				writeToTemplate(writer, body, "resources/templates/share/init.html", "resources/templates/share/include/share/share_right_option.html", "resources/templates/app/include/folder_selector.html", "resources/templates/app/include/head.html", "resources/templates/app/include/top-bar.html", "resources/templates/share/include/share/share_toolbar.html", "resources/templates/share/include/share/share_list.html")
			}()
			if !inerceptor.StartTransaction(writer, request) {
				return
			}
